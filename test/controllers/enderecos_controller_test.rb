...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, endereco: { amigo_id: @endereco.amigo_id, bairro: @endereco.bairro, cidade: @endereco.cidade, lagradouro: @endereco.lagradouro, numero: @endereco.numero, uf: @endereco.uf }
    end
  ...
  test "should update endereco" do
    patch :update, id: @endereco, endereco: { amigo_id: @endereco.amigo_id, bairro: @endereco.bairro, cidade: @endereco.cidade, lagradouro: @endereco.lagradouro, numero: @endereco.numero, uf: @endereco.uf }
    assert_redirected_to endereco_path(assigns(:endereco))
  end
