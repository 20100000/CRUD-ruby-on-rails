...
class AmigosControllerTest < ActionController::TestCase
  ...
  test "should create amigo" do
    assert_difference('Amigo.count') do
      post :create, amigo: { email: @amigo.email, endereco: @amigo.endereco, name: @amigo.name, tel: @amigo.tel }
    end
  ...
  test "should update amigo" do
    patch :update, id: @amigo, amigo: { email: @amigo.email, endereco: @amigo.endereco, name: @amigo.name, tel: @amigo.tel }
    assert_redirected_to amigo_path(assigns(:amigo))
  end
